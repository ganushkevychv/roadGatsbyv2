...
const About = (props) => (
  ...
  <div className="container">
    <SEO title="О нас | Елисаветдорбуд" keywords={[`Ремонт дорог Кропивницкий`, `Кировоградская область`, `строительство дорог Кропивницкий`, `ремонт тротуаров Кропивницкий`]} />
